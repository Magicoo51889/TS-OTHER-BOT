 ...
 * ```
 */
export declare type P_Options<List extends P_Tuple.NonEmpty> = List extends [infer X] ? X : List[0] extends never ? P_Tuple.Tail<List> extends P_Tuple.NonEmpty ? P_Options<P_Tuple.Tail<List>> : never : List[0];
