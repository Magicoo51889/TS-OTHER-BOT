...
export declare namespace P_Function {
    /**
     * any function
     */
    type Instance = (...args: any) => any;
    /**
     * @param F function
     * @param T target type
     ...
     * ```
     */
    type FilterParameters<F extends Instance, T> = P_List.FilterMap<Parameters<F>, T>;
    /**
     ...
     * ```
     */
    type Pipe<FunctionList extends Instance[], StartParams extends any[] = Parameters<FunctionList[0]>> = FunctionList extends [] ? never : FunctionList extends P_Tuple.NonEmpty ? FunctionList[0] extends Instance ? FunctionList extends [any] ? (...args: StartParams) => ReturnType<FunctionList[0]> : FunctionList extends [any, any, ...any[]] ? Parameters<FunctionList[1]> extends [any] ? ReturnType<FunctionList[0]> extends Parameters<FunctionList[1]>[0] ? Pipe<P_Tuple.Tail<FunctionList>, StartParams> : never : never : never : never : ReturnType<P_Array.Item<FunctionList>> extends Parameters<P_Array.Item<FunctionList>>[0] ? P_Array.Item<FunctionList> : never;
    /**
     ...
     * ```
     */
    type Compose<FunctionList extends Instance[]> = Pipe<P_List.Revert<FunctionList>>;
}
