 ...
 */
export declare namespace P_List {
    /**
     * `[0] - [ ] - [ ] - [ ] - ...`
     * @param List
     ...
     * ```
     */
    type Head<T extends any[]> = T extends P_Tuple.Instance ? P_Tuple.Head<T> : P_Array.Head<T>;
    /**
     * `[ ] - [0] - [0] - [0] - ...`
     * @param List
     ...
     * ```
     */
    type Tail<T extends any[]> = T extends P_Tuple.Instance ? P_Tuple.Tail<T> : P_Array.Tail<T>;
    /**
     * `[A] - [A] - [A] - ... => A`
     *
     * `[A] - [B] - [C] - ... => (A | B | C | ...)`
     ...
     * ```
     */
    type Item<T extends any[]> = T extends P_Tuple.Instance ? P_Tuple.Item<T> : P_Array.Item<T>;
    /**
     * @param List
     * @param T target type
     ...
     * ```
     */
    type Filter<List extends any[], T> = List extends P_Tuple.Instance ? P_Tuple.Filter<List, T> : P_Array.Filter<List, T>;
    /**
     * @param List
     * @param T target type
     ...
     * ```
     */
    type Map<List extends any[], T> = List extends P_Tuple.Instance ? P_Tuple.Map<List, T> : P_Array.Map<List, T>;
    /**
     * @param List
     * @param T target type
     ...
     * ```
     */
    type FilterMap<List extends any[], T> = List extends P_Tuple.Instance ? P_Tuple.FilterMap<List, T> : P_Array.FilterMap<List, T>;
    /**
     * @param List
     * @param T target type
     ...
     * ```
     */
    type Find<List extends any[], T> = List extends P_Tuple.Instance ? P_Tuple.Find<List, T> : P_Array.Find<List, T>;
    /**
     * @param List
     * @param T target type
     * @returns `true ^ false`
     ...
     * ```
     */
    type Every<List extends any[], T> = List extends P_Tuple.Instance ? P_Tuple.Every<List, T> : P_Array.Every<List, T>;
    /**
     * @param List
     ...
     * ```
     */
    type Revert<List extends any[]> = List extends P_Tuple.Instance ? P_Tuple.Revert<List> : List;
}
